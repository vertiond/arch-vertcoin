...
sha256sums=('32a3ab16c6680f43962ce4f62f8397f4d6111d4e589ae70d298b29526a62afc5'
...
build() {
  cd $pkgbase-$pkgver
  ./configure --prefix=/usr --with-gui=qt5 --with-incompatible-bdb --disable-tests --disable-bench
  make
}
...
package_vertcoin-qt() {
  ...
  install -Dm644 src/qt/res/src/vertcoin.svg \
    "$pkgdir"/usr/share/icons/hicolor/scalable/apps/vertcoin-qt.svg
...
package_vertcoin-daemon() {
  ...
  install -Dm644 contrib/init/vertcoind.service \
    "$pkgdir/usr/lib/systemd/system/vertcoind.service"
